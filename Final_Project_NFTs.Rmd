...
NFT stands for “New Fangled Technology”...just kidding, NFT stands for “Non-Fungible Token”. “Non-Fungible” means something that cannot be replaced with something else that is the same. NFTs work similarly to cryptocurrency in that they are a part of the blockchain but there are some important distinctions. NFTs are one-of-a-kind and thus cannot be exchanged for something of exact equal value, whereas a unit of cryptocurrency can be precisely exchanged for a different unit of the same cryptocurrency (1 Etherium = 1 Etherium). In this project we are going to try and determine if NFTs have the potential to be a good investment (or if they are even going to stay relevant).
...
1) The  data https://www.kaggle.com/mathurinache/nft-history-sales I sourced this data from the kaggle public datasets. It was collected by Mathurin Ache on 11/21 by the source 
https://nonfungible.com/ and 
Https://nonfungible.com/blog/how-to-extract-nft-data-from-nonfungible-com. The purpose of this dataset was to help on how to make money using NFT and AI.
...
#### Active Wallets
Data shows that the active wallets have increased throughout the years, and according to our current graphs shows the highest peak record in October of 2022 with 30,129 the most active wallets. 
...
Are NFTs a good investment or are they just a fad? We compare a variety of plots to visualize the potential growth in sales.
